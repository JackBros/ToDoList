...
import 'package:flutter_riverpod/flutter_riverpod.dart' show AsyncValueX, ConsumerWidget, FutureProvider, Provider, WidgetRef;
import 'package:to_do_list/models/cat_fact_model.dart' show CatFactModel;
    ...
    return Scaffold(
      body: SafeArea(
        child: _liste.when(
          ...
          error: (err, stack) {
            return Center(
              child: Text('error occurred ${err.toString()}'),
            );
          },
