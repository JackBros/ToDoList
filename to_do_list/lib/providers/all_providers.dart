import 'package:flutter_riverpod/flutter_riverpod.dart' show Provider, StateNotifierProvider, StateProvider;
...
final todoListProvider =
  ...
  return TodoListManager([
    TodoModel(id: const Uuid().v4(), description: 'Workout'),
    TodoModel(id: const Uuid().v4(), description: 'Study'),
    TodoModel(id: const Uuid().v4(), description: 'Shopping'),
    TodoModel(id: const Uuid().v4(), description: 'Watch Movie/Serie'),
  ]);
});
